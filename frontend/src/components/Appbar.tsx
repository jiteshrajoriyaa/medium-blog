...
export const Appbar:React.FC<nameProp> = ({name}) => {

    return <div className="w-screen bg-white  fixed top-0  z-10">
            <div className="flex justify-center">
            <div className="w-11/12 h-18 lg:h-20 flex items-center justify-between">
               <Link to={"/blogs"} ><div>
                    <img
                        className="block max-w-12 min-w-6 lg:min-w-9 lg:max-w-13 h-auto"
                ...
                <Link to={"/new-story"} >
                <img 
                className="max-w-5 min-w-6 lg:min-w-7"
                src="https://www.svgrepo.com/show/503122/write.svg" alt="" />
                </Link>
                <Avtar name={name}/>
                </div>
        </div>
...
export const AppBarForCreateBlog = ({name}: {name: string})=>{
    ...
    return <div className="w-screen fixed top-0  z-10 bg-white">
        <div className="flex justify-center">
            <div className="w-10/12 md:w-full md:px-3 lg:w-4/5 h-20 flex items-center justify-between ">
